...
#  gem 'hydra', '~>8.0'
  ...
  gem 'avalon-workflow', path: '~/gitproj/avalon-workflow/' #      git: 'https://github.com/avalonmediasystem/avalon-workflow.git', tag: 'flash_update'
  ...
  gem 'multipart-post'
  #gem 'modal_logic', path: '~/gitproj/modal_logic/'
...
#  gem 'zoom', '~>0.4.1', :git => 'https://github.com/bricestacey/ruby-zoom.git'
  ...
  group :debug do
    ...
    gem 'pry-byebug',   platforms: [:mri_20, :mri_21, :mri_23]
  end
